...
import ContributionGraph from '@/module/dashboard/components/graph-graph';
...
const MainPage = () => {
  ...
  return (
    <div className='space-y-6'>
      <div>
        <h1 className='text-3l font-bold tracking-tight'>Dashboard</h1>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <Card className='col-span-2'>
          <CardHeader>
            ...
            <CardDescription>Monthly Breakdown of commits, PRs, and reviews (last 6 mons)</CardDescription>
          </CardHeader>
          <CardContent>
            {
              isLoadingActivity ? (
